import "./solicitacaoRevisaoPev.css"
      ...
      <main className="conteiner-main">
        ...
        <form className="formulario-valid" onSubmit={handleSubmit(addDados)}>
          ...
          <div className="div-inp">
            ...
            <input
              type="text"
              placeholder="Digite o endereço do PEV"
          ...
          <div className="form-grup2-2">
            <div className="div-inp">
              ...
              <input
                type="text"
                placeholder="Digite o código da PEV"
...
export default SolicitarRevisao